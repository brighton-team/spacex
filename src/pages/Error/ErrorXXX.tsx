...
export const ErrorPageXXX: React.FC<ownProps> = (props: ownProps) => {
  ...
  let numberContext = hashNumber?hashNumber:number;
  numberContext=typeof(numberContext)==='string'&&numberContext.match(/^[0-9]+$/)?parseInt(numberContext):numberContext;
  const is4XX = numberContext<500?true:false;
